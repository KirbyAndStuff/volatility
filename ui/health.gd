...
func _ready() -> void:
	...
	player.connect("is_speed_boosted", change_speed_boost)
	player.connect("changed_weapon", change_weapon_visible)
...
func _process(_delta):
	...
	var parry_cooldown = player.parry_cooldown
	...
	var gunm2_cooldown = (player.gunm2_cooldown)
	...
	var laser_cooldown = (player.alt_gunm2_cooldown)
	...
	var slash_cooldown = (player.meleem2_cooldown)
	...
	var heal_cooldown = (player.heal_cooldown)
